...
#define CLIENT_TCP_PORT 0X1002 // 4098 (big endian为528)
...
int main()
{
    ...
    for(;;)
    {
        ...
        //get the input
        printf("please input something (or write 'quit' to exit): ");
        memset(sendbuf, '\0', sizeof(sendbuf));
        fgets(sendbuf, sizeof(sendbuf)-1, stdin);

        //quit, write the quit request and shutdown client
        if(strncmp(sendbuf,"quit", 4) == 0)  goto exit;
