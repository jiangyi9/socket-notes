...
It has nothing to do with the specific CPU type, operating system, so as to ensure that the data can be interpreted correctly when transmitted between different hosts. 
